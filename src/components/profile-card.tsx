...
import { Download, Linkedin, EyeIcon } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: `linear-gradient(${
                rotation.y * 3 + 135
              }deg, transparent 30%, rgba(255,255,255,0.05) 50%, transparent 70%)`,
              opacity: isHovered ? 1 : 0,
            }}
          />
          ...
          <div className="relative z-10 flex flex-col items-center gap-8">
            ...
            >
              <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-slate-100 via-blue-200 to-slate-100 bg-clip-text text-transparent">
                Marcio Sardou
              </h1>
            ...
            {/* Description */}
            <p
              className="text-center text-slate-300 max-w-lg text-base md:text-md leading-relaxed"
              style={{
            ...
            >
              ...
              e <span className="text-green-400 font-semibold">acessíveis</span>{" "}
              usando as melhores tecnologias do mercado.
            </p>
            {/* Action Buttons */}
            <div
              className="flex flex-col sm:flex-col gap-3 w-full sm:w-auto mt-4"
              style={{
            ...
            >
              <div className="flex flex-row gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    window.open(
                      "https://linkedin.com/in/marcioSardou",
                      "_blank"
                    );
                  }}
                >
              ...
              <Button
                size="lg"
                className="w-full gap-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300"
              >
